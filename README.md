...
- Cinderfen village cargo uses reviewed neutral crates, barrels, handcarts, washing lines and planters fitted to measured bounds by `scripts/campaign/cinderfen-dressing.mjs`. New nature, wildlife and population sources remain draft; consult `docs/overnight-world-work-state.md` before resuming their paused production.
