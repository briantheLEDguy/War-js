...
prop_preview_twisted_tree_t1.glb
prop_preview_blight_shrub_t1.glb
prop_preview_jagged_stone_t1.glb
prop_preview_dreary_reeds_t1.glb
```
...
Blender preview screenshots and other human QC renders are written under
`artifacts/blender/manifest/`. That directory is ignored, can be deleted during
cleanup, and is regenerated by the manifest pipeline when assets are rebuilt.
