...
LABELS={'belt':'quartermaster_belt_attachment_support','case':'quartermaster_ledger_case_shell',
        'belt_contact':'quartermaster_case_suspension_belt_contact',
        'case_contact':'quartermaster_case_suspension_case_contact'}
...
points,faces=geometry([bpy.data.objects[name] for name in ('work_belt','quartermaster_closed_ledger_case','quartermaster_case_suspension_0','quartermaster_case_suspension_1')])
