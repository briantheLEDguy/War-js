...
candidates=[tuple(face.vertices) for face in body.data.polygons if body.data.materials[face.material_index].name=='quartermaster_supply_waistcoat']
...
band_faces=[tuple(face.vertices) for face in body.data.polygons
            if body.data.materials[face.material_index].name=='quartermaster_belt_attachment_support'
