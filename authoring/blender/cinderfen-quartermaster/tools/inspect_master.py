...
source=WORK/'sources/frontier_cinderfen_greenskin_quartermaster.blend'
bpy.ops.wm.open_mainfile(filepath=str(source))
rig=next(o for o in bpy.context.scene.objects if o.type=='ARMATURE');rig.animation_data_clear()
for bone in rig.pose.bones:bone.matrix_basis.identity()
bpy.context.view_layer.update()
required=['shirt_continuous_tailored_surface','trousers_continuous_tailored_surface','fitted_boot_-1','fitted_boot_1','quartermaster_waistcoat','work_belt','quartermaster_closed_ledger_case','quartermaster_curved_lower_tusk_-1','quartermaster_curved_lower_tusk_1','quartermaster_case_suspension_0','quartermaster_case_suspension_1','quartermaster_bellows_pocket_-1','quartermaster_bellows_pocket_1']
records=[]
