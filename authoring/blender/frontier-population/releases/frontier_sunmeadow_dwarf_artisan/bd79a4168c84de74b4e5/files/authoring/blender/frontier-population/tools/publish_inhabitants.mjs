...
metadata.assets[profile] = { runtimeReady: true, modelSha256: lods[0].sha256, label: name, group: 'Characters and NPCs',
  defaultScale: 1, defaultAnimation: 'idle', footprint: { width: Number((bounds.max[0]-bounds.min[0]).toFixed(3)), depth: Number((bounds.max[2]-bounds.min[2]).toFixed(3)), chainAxis: 'z' },
