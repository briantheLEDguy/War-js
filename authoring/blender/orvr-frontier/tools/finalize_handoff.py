...
def main():
    ...
    wagon.pop('driverAnimationAsset',None); wagon.pop('driverClip',None)
    wagon['driverAvatarOriginGltf']=pose['avatar_origin_wagon_local_gltf']
    ...
    assets['frontier_draft_horse']['clips']=[]
    assets['frontier_draft_horse']['animationStatus']='Requires a separately approved native quadruped set'
    ...
    assets.pop('frontier_teamster_animations',None)
