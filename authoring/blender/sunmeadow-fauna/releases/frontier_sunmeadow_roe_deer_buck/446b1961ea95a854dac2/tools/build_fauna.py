...
def build(kind,definition,rest_only=True):
    ...
    source_files=['source/anatomy.json',*['tools/'+name for name in ['build_fauna.py','quadruped_rig.py','gait_curves.py','bird_geometry.py','hoof_geometry.py','stitched_skin.py','atlas_checks.py','surface_detail.py','texture_detail.py','texture_lods.py']]]
