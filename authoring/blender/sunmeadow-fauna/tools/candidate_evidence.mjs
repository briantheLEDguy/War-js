...
export async function collectCandidateDelivery(root, asset, clips, relative) {
  ...
  requireCandidateViews(receipts.renders, clips);
  const identities = new Set();
  const renders = receipts.renders.map(render => {
