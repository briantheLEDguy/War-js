...
applicable, visual and runtime checks. A finished asset package does not finish a zone.

## Active batch

| Work | Owner | Current state | Integration dependency |
|---|---|---|---|
| Sunmeadow tree crowns and six wildlife models | Ecology agent | Canopy revision published; fauna anatomy and motion remain in review | In-game canopy check; fauna surface and deformation acceptance |
