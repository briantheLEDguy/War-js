...
| 3: RPG | All current combat, progression, inventory, gathering/crafting, quests and HUD behavior under server authority | Inventory rules pass seven browser-derived scenarios; private bag/equipment replication, reward receipts, atomic exchanges, deferred delivery and consumables have native/two-client evidence. Initial inventory panel implemented. Complete UI parity, durable economy, crafting integration and remaining RPG systems are pending |
