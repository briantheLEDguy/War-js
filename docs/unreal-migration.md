...
| 3: RPG | All current combat, progression, inventory, gathering/crafting, quests and HUD behavior under server authority | Inventory rules pass seven browser-derived scenarios; private inventory, atomic exchanges, deferred delivery, consumables and recipe execution have native/two-client evidence. Initial inventory/portable crafting panel implemented. Complete UI/profession/world parity, durable economy and remaining RPG systems are pending |
