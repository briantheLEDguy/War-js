...
const KEEP_FURNISHINGS = [
  ...
  { key: 'frontier_field_command_table', role: 'command_table', sign: 1,
    candidates: [[8, 2], [6, 2], [8, 13], [6, 13], [5, -6], [10, 2], [10, -6], [12, 2], [12, -6], [8, -12], [6, -12]] },
];
export const SHARED_KEEP_ITEMS = KEEP_FURNISHINGS.map(item => item.key);

export function sharedKeepItemMetadata() {
  return Object.assign({}, ...['frontier-workshop-items', 'field-apothecary', 'field-supply-chest', 'field-arms-rack', 'field-command-table'].map(name => {
