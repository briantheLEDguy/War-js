...
output = ROOT / "artifacts/unreal/licensed-kits/house-kit-staged.json"
output.unlink(missing_ok=True)
registry = unreal.AssetRegistryHelpers.get_asset_registry()
registry.search_all_assets(True)
prefix = "/Game/Medieval_Environment/"
names = {"SM_MH_02_House_02", "SM_MH_02_Stone_Floor_01", "SM_MH_02_Stone_Wall_01",
         "SM_MH_02_Stone_Wall_Door_01", "SM_MH_02_Stone_Stairs_01"}
...
unreal.log("WAR_CITY_KIT_STAGED=" + str(output))
