...
const furnishingContracts = () => Object.assign({}, ...['frontier-workshop-items', 'field-apothecary', 'field-supply-chest', 'field-arms-rack']
...
test('siege contents share keys across pairings while existing thematic exteriors stay intact', async () => {
  ...
  for(const map of maps) {
    ...
    expect(items, map.id).toHaveLength(10);
